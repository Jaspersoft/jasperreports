...
//							);
		...
		) throws JRException
	{
		...
		{
			long scaledPageHeight = (long) pageHeight * subreportDpi / parentDpi;
			subreportFiller.setPageHeight(scaledPageHeight > Integer.MAX_VALUE ? pageHeight : (int) scaledPageHeight);
		}
		else
		{
