...
public class JRViewerPanel extends JPanel implements JRHyperlinkListener, JRViewerListener
{
	...
	{
		// the dimensions of the page on display are expressed in the resolution of its page
		// format, which is the one of the part the page belongs to
		return (float) REPORT_RESOLUTION / viewerContext.getPageFormat().getDpi();
	}
