...
import net.sf.jasperreports.json.export.schema.JsonMetadataWriter;
import net.sf.jasperreports.json.export.schema.MetadataProcessor;
 ...
 */
public abstract class AbstractMetadataExporter extends JRAbstractExporter<JsonMetadataReportConfiguration, JsonExporterConfiguration, WriterExporterOutput, JsonExporterContext>
{

	private static final Log log = LogFactory.getLog(AbstractMetadataExporter.class);
	...
	public AbstractMetadataExporter(JasperReportsContext jasperReportsContext)
	{
	...
	public void exportReport() throws JRException
	{
		...
		jsonProcessor = createMetadataProcessor(writer);
	...
	protected abstract MetadataProcessor createMetadataProcessor(Writer writer);

	protected abstract void passConfigToProcessor(MetadataProcessor processor, JsonMetadataReportConfiguration configuration );
	...
	protected void exportReportToWriter() throws JRException, IOException
	{
		...
		for(reportIndex = 0; reportIndex < items.size(); reportIndex++)//FIXMEJSONMETA deal with batch export
		{
			...
			passConfigToProcessor(jsonProcessor, currentItemConfiguration);
